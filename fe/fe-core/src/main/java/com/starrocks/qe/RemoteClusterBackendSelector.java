...
public class RemoteClusterBackendSelector implements BackendSelector {
    private static final Logger LOG = LogManager.getLogger(RemoteClusterBackendSelector.class);
    ...
    public RemoteClusterBackendSelector(ScanNode scanNode, List<TScanRangeLocations> locations,
