...
public class OlapTableSink extends DataSink {
    ...
    public void complete() throws UserException {
        ...
        tSink.setNodes_info(GlobalStateMgr.getCurrentState().createNodesInfo(warehouseId, getSystemInfoService(dstTable), dstTable));
                ...
                for (int idx = 0; idx < index.getTablets().size(); ++idx) {
                    ...
                    if (table.isCloudNativeTableOrMaterializedView()) {
                        ...
                        Multimap<Replica, Long> bePathsMap =
                                localTablet.getNormalReplicaBackendPathMap(getSystemInfoService(table));
